...
<?php include 'sideMenu.php'; ?>
        ...
        <div class="p-4 sm:p-6">
            ...
            <div class="relative overflow-x-auto shadow-md rounded-md sm:rounded-lg mt-2">
                ...
                ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 poli-description">
                               <?= htmlspecialchars($row['keterangan']); ?>
                            </td>
                            <td class="px-6 py-4 flex space-x-2">
                                <button class="edit-btn text-blue-500 hover:underline">Edit</button>
                                <button class="delete-btn text-red-500 hover:underline">Hapus</button>
                            </td>
                        </tr>
                          <?php
                    endwhile;
            ...
            <?php if (isset($message)): ?>
                    <div class="p-2 mb-4 text-sm text-white bg-green-500 rounded-lg">
                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-lg">
                        ...
                        <form action="#" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="description" name="description" rows="4" class="w-full p-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Tambahkan Deskripsi Poli"></textarea>
                            </div>
            ...
            <div id="edit-modal" class="hidden fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-lg">
                    ...
                    <form id="edit-form">
                        ...
                        <div class="mb-4">
                            <label for="edit-description" class="block text-sm font-medium text-gray-700  dark:text-white">Deskripsi</label>
                            <textarea id="edit-description" name="edit-description" rows="4" class="w-full p-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white"placeholder="Edit Deskripsi Poli"></textarea>
                        </div>
                        <div class="flex justify-end space-x-2">
                            <button type="button" id="edit-close-btn"class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 dark:bg-gray-600 dark:text-white dark:hover:bg-gray-700 mr-2">Tutup</button>
