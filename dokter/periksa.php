...
<!-- Tampilan -->
<h1 class="text-3xl font-bold dark:text-white text-center">Daftar Pasien Menunggu</h1>
<p class="mt-2 text-gray-600 dark:text-gray-100 text-center">
    Pasien yang belum diperiksa oleh dokter.
</p>

<div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mt-6">
    <h2 class="text-2xl font-bold text-gray-700 dark:text-gray-100">Pasien Menunggu</h2>
